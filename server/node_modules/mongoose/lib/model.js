...
Model.findByVal = function findByVal(value, projection, options, callback) {
  ...
  return this.findAOne({test_type: value}, projection, options, callback);
};

Model.search = function search(name, projection, options, callback) {
  ...
  var pattern = new RegExp(name+'.*', "i"); /* case-insensitive RegExp search */
